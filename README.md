...
```sh
gh release download v0.6.0 -p 'dev-vm_*_darwin_arm64.tar.gz'
tar xzf dev-vm_0.6.0_darwin_arm64.tar.gz
install dev-vm_0.6.0_darwin_arm64/dev-vm /usr/local/bin/dev-vm
```

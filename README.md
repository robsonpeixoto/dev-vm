...
```sh
gh release download v0.9.0 -p 'dev-vm_*_darwin_arm64.tar.gz'
tar xzf dev-vm_0.9.0_darwin_arm64.tar.gz
install dev-vm_0.9.0_darwin_arm64/dev-vm /usr/local/bin/dev-vm
```

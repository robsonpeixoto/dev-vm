...
set -l dev_vm_commands create start stop delete list status completion version help
...
complete -c dev-vm -n "not __fish_seen_subcommand_from $dev_vm_commands" -a delete -d 'delete a dev VM and its GitHub key'
...
complete -c dev-vm -n '__fish_seen_subcommand_from delete' -o force -d 'skip the confirmation prompt'
